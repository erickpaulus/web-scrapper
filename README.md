...
3. Write your code in Python. Please several sample in the jupyter notebook files inside this repository. In web-scraper-KPU.ipynb, we learn how to obtain open data from KPU 2019.
